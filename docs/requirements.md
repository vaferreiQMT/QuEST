...
> **TOC**:
> - [Frontend](#requirements_frontend)
> - [Backend](#requirements_backend)
>    * [Multithreading](#requirements_multithreading)
>    * [Distribution](#requirements_distribution)
>    * [GPU](#requirements_gpu)
>    * [Distribution + GPU](#requirements_comm-gpu)
>    * [GPU + cuQuantum](#requirements_gpu-cuquantum)
...
Enabling multithreading requires compiling `cpu/` with an [OpenMP](https://www.openmp.org/)-compatible compiler. So far, QuEST has been tested with [OpenMP](https://www.openmp.org/specifications/) 2.0, 4.5 as used by the aforementioned compilers.
...
- [Open MPI](https://www.open-mpi.org/) 4, 5
- [MPICH](https://www.mpich.org/) 4
- [MS-MPI](https://learn.microsoft.com/en-us/message-passing-interface/microsoft-mpi) 10
...
Simultaneously emabling both distribution _and_ GPU-acceleration is possible with use of the separate compilers above. However, simulation can be accelerated by using a [CUDA-aware MPI](https://developer.nvidia.com/blog/introduction-cuda-aware-mpi/) compiler, enabling QuEST to use [GPUDirect](https://developer.nvidia.com/gpudirect) and avoid superfluous exchanges of CPU and GPU memories. So far, QuEST has been tested with [UCX](https://openucx.org/) 1.13, 1.15.


### GPU + cuQuantum {#requirements_gpu-cuquantum}

Enabling [cuQuantum](https://developer.nvidia.com/cuquantum-sdk) on NVIDIA GPUs with [compute-capability](https://developer.nvidia.com/cuda-gpus) >= `7.0` requires use of a modern CUDA compiler, specifically [CUDA](https://docs.nvidia.com/cuda/cuda-toolkit-release-notes/index.html) 11, 12.
